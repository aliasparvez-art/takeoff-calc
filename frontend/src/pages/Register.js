    ...
    <div className="min-h-screen bg-qto-bg flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        ...
        <div className="qto-panel p-8">
          ...
          {error && (
            <div className="bg-qto-error/10 border border-qto-error rounded-qto p-3 mb-4" data-testid="register-error">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <label className="qto-label">Full Name</label>
              <input
                type="text"
                value={name}
          ...
          <p className="text-center text-qto-text-secondary text-sm">
            ...
            <Link to="/login" className="text-qto-primary hover:text-qto-primary-hover transition-qto" data-testid="login-link">
              Sign in
            </Link>
          </p>
        </div>
